...
- To report issue and contribution visit [Github](https://github.com/EssentialBlocks/infobox).
- If you have any more questions, visit our support on the [Plugin's Forum](https://wordpress.org/support/plugin/infobox).
...
= Old Way: =
1. Upload `infobox` to the `/wp-content/plugins/` directory
...
= 1.2.2 - 12/09/2022 =
* Fixed: Open in new tab option in URL
* Improved: Controls and structure.

= 1.2.1 - 25/05/2022 =
* Added: Responsive Control, Animation, Custom Css
